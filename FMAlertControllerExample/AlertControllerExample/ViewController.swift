...
class ViewController: UIViewController {
    ...
    @IBAction func AlertWithFadeAnimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithFadeAnimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
        }, animationStyle: .fade)
    ...
    @IBAction func AlertWithShakeAnimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithShakeAnimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
    ...
    @IBAction func AlertWithSlideDownAimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithSlideDownAimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
    ...
    @IBAction func AlertWithSlideUpAimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithSlideUpAimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
    ...
    @IBAction func AlertWithSlideRightAimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithSlideRightAimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
    ...
    @IBAction func AlertWithSlideLeftAimation(_ sender: AnyObject) {
        ...
        FMAlertController.show("Hello", message: "AlertWithSlideLeftAimation", cancelButtonTitle: "Cancel", completionBlock: { () -> (Void) in
            print("Cancel Pressed")
