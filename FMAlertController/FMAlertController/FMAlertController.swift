...
public class FMAlertController: UIViewController {
    ...
    fileprivate func FMAlertController(_ title:String,message:String,cancelButtonTitle:String,animationStyle:animationType,completionBlock: @escaping () -> (Void)){
    ...
    fileprivate func FMAlertController(_ title:String,message:String,cancelButtonTitle:String,firstButtonTitle:String,animationStyle:animationType,firstActionCompletion: @escaping () -> (Void),cancelCompletionBlock: @escaping () -> (Void)){
    ...
    fileprivate func FMAlertController(_ title:String,message:String,firstButtonTitle:String,secondButtonTitle:String,cancelButtonTitle:String,animationStyle:animationType,firstActionCompletion: @escaping () -> (Void),secondActionCompletion: @escaping () -> (Void),cancelCompletionBlock: @escaping () -> (Void)){
...
public extension FMAlertController {
    ...
    class func show(_ title:String?,message:String?,cancelButtonTitle:String,completionBlock: @escaping ()->(Void),animationStyle:animationType = .default){
        ...
        let bundle = Bundle(path: Bundle(for: self.classForCoder()).path(forResource: "FMAlertController", ofType: "bundle")!)
        let alertView = self.init(nibName: "FMAlertController", bundle: bundle)
        alertView.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        alertView.modalTransitionStyle = UIModalTransitionStyle.crossDissolve
        
        alertView.FMAlertController(title ?? "", message: message ?? "", cancelButtonTitle: cancelButtonTitle,animationStyle:animationStyle, completionBlock:completionBlock)
    ...
    class func show(_ title:String?,message:String?,firstButtonTitle:String,firstActionCompletion: @escaping ()->(Void),cancelButtonTitle:String,cancelCompletionBlock: @escaping ()->(Void),animationStyle:animationType = .default){
        ...
        alertView.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        alertView.modalTransitionStyle = UIModalTransitionStyle.crossDissolve
        alertView.FMAlertController(title ?? "", message: message ?? "", cancelButtonTitle: cancelButtonTitle, firstButtonTitle: firstButtonTitle,animationStyle:animationStyle, firstActionCompletion: firstActionCompletion, cancelCompletionBlock: cancelCompletionBlock)
